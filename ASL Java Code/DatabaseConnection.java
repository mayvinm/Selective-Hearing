...
public class DatabaseConnection {
    ...
    public DatabaseConnection() {       
        try {
            ...
            "jdbc:mysql://localhost:3306/asl?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=America/New_York", "root", "");
            //System.out.println("Database connection successful!");
        
            String maxIDQuery = "select max(tableID) from login";
