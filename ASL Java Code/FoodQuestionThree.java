...
public class FoodQuestionThree{
    ...
    private JFrame frame = new JFrame("Food Quiz: Question Three");
    ...
    private JLabel questionThree = new JLabel("This is an orange. True or False?");
