 ...
 */
public class GreetQuestionThree{
    ...
    private JFrame frame = new JFrame("Greetings Quiz: Question Three");
    ...
    private JLabel questionThree = new JLabel("This means 'You're welcome'. True or False?");
