 ...
 */
public class AlphaQuestionFive{
    ...
    private JFrame frame = new JFrame("Alphabet Quiz: Question Five");
    ...
    private JLabel questionFive = new JLabel("What letter is this?");
    private JRadioButton w = new JRadioButton("W");
    private JRadioButton r = new JRadioButton("R");
    private JRadioButton s = new JRadioButton("S");
    private JRadioButton h = new JRadioButton("H");
