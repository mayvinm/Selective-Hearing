...
public class GreetQuestionTwo{
    ...
    private JFrame frame = new JFrame("Greetings Quiz: Question Two");
    ...
    private JLabel questionTwo = new JLabel("This means 'Please'. True or False?");
